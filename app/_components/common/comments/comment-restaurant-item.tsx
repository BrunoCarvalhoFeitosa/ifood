...
import { CommentRestaurantAlertDialog } from "./comment-restaurant-alert-dialog"
import { ClockIcon, Trash2Icon } from "lucide-react"

interface CommentRestaurantItemProps {
  currentUser: SafeUser | null
  commentId: string
  comment: CommentRestaurant
}

export const CommentRestaurantItem = ({
  currentUser,
  commentId,
  comment
